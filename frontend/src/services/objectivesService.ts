...
// Types TypeScript pour objectivesService
interface Objective {
  _id: string;
  title: string;
  description?: string;
...
interface UpdateObjectiveData extends Partial<CreateObjectiveData> {
  currentValue?: number;
  status?: 'pending' | 'in_progress' | 'completed';
}
...
export const objectivesService = {
  ...
  getByClient: async (clientId: string): Promise<ApiResponse<Objective[]>> => {
  ...
  getHighImpact: async (): Promise<ApiResponse<Objective[]>> => {
  ...
  create: async (objectiveData: CreateObjectiveData): Promise<ApiResponse<Objective>> => {
  ...
  update: async (id: string, objectiveData: UpdateObjectiveData): Promise<ApiResponse<Objective>> => {
  ...
  updateProgress: async (id: string, currentValue: number): Promise<ApiResponse<Objective>> => {
  ...
  linkTask: async (objectiveId: string, taskId: string): Promise<ApiResponse<any>> => {
  ...
  unlinkTask: async (objectiveId: string, taskId: string): Promise<ApiResponse<any>> => {
